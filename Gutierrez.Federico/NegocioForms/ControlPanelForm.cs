...
namespace NegocioForms {
     ...
     public partial class ControlPanelForm : Form {
        ...
        private void dtaGridMainInfo_CellContentClick(object sender, DataGridViewCellEventArgs e) {
            ...
            else if (e.ColumnIndex == dtaGridMainInfo.Columns["agregarStockColumn"].Index) {
                Producto producto = (Producto)this.dtaGridMainInfo.Rows[e.RowIndex].DataBoundItem;
                Negocio.InvNegocio.CambiarStockInventario(producto, 1);
            }
        ...
        private void SubMenuProductosToolStripMenuItem_Click(object sender, EventArgs e) {
            ...
            this.dtaGridMainInfo.DataSource = Negocio.InvNegocio.ListaProductosInv;
            this.dtaGridMainInfo.Columns["agregarStockColumn"].Visible = true;
            this.dtaGridMainInfo.Columns["agregarStockColumn"].DisplayIndex = 7;

        }
        private void SubMenuControlarStockToolStripMenuItem_Click(object sender, EventArgs e) {

            this.dtaGridMainInfo.DataSource = Negocio.InvNegocio.ProductosConStock(-11);
            this.dtaGridMainInfo.Columns["agregarStockColumn"].DisplayIndex = 7;
            this.dtaGridMainInfo.Columns["agregarStockColumn"].Visible = true;
