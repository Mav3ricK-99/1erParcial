...
namespace NegocioForms {
    public partial class CompraForm : Form {
        ...
        private string InfoPago() {
            ...
            this.lblNombre.Location = new Point(11, 288);
            this.lblDNI.Location = new Point(141, 288);
            switch (this.cmboxMetodoPago.SelectedItem) {
                ...
                case EMetodoPago.BTC: {
                        ...
                        this.lblNombre.Location = new Point(11, 248);
                        this.lblDNI.Location = new Point(141, 248);
                    }; break;
            }
        ...
        private void btnEfectuar_Click(object sender, EventArgs e) {
            ...
            if (UsuarioIngresado.Comprar((EMetodoPago)this.cmboxMetodoPago.SelectedItem, this.txtBoxDatoPago.Text)) {
                ...
                System.Media.SoundPlayer sonidoCompra = new System.Media.SoundPlayer(Properties.Resources.registradora);
                sonidoCompra.Play();
            }

        }
        private void TimerEventProcessor(Object timer, EventArgs myEventArgs) {
            Timer myTimer = (Timer)timer;
            myTimer.Stop();
