...
namespace NegocioForms {
    partial class ControlPanelForm {
        ...
        private void InitializeComponent() {
            ...
            this.agregarStockColumn = new System.Windows.Forms.DataGridViewButtonColumn();
            ...
            this.agregarStockColumn.DefaultCellStyle = dataGridViewCellStyle3;
            this.agregarStockColumn.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
            this.agregarStockColumn.HeaderText = "AgregarStock";
            this.agregarStockColumn.Name = "agregarStockColumn";
            this.agregarStockColumn.ReadOnly = true;
            this.agregarStockColumn.Resizable = System.Windows.Forms.DataGridViewTriState.False;
            this.agregarStockColumn.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.Automatic;
            // 
            // ControlPanelForm
            // 
        ...
        private void CargarVista() {
            ...
            else if (this.usuarioIngresado is Empleado) {
                this.GenerarVistaEmpleado();
                this.MostrarCierreSesion();
            }
            else if (this.usuarioIngresado is Invitado) {
                this.GenerarVistaCliente();
                this.lblUltimaCompra.Visible = false;
                this.MostrarLoginYRegistro();
            }
        }
        private void GenerarVistaCliente() {
            ...
            this.dtaGridMainInfo.Columns["CantVendidos"].Visible = false;
            this.dtaGridMainInfo.Columns["agregarStockColumn"].Visible = false;
        }
        private void GenerarVistaEmpleado() {
            ...
            this.dtaGridMainInfo.Columns[1].DisplayIndex = 7;
            this.dtaGridMainInfo.Columns["carritoColumn"].Visible = false;
            this.dtaGridMainInfo.Columns["CantVendidos"].Visible = true;

            System.Windows.Forms.ToolStripMenuItem menuEmpleado = new System.Windows.Forms.ToolStripMenuItem("Empleado");

            System.Windows.Forms.ToolStripMenuItem subMenuEmpleadoListado = new System.Windows.Forms.ToolStripMenuItem("Ver listado");
            ...
            System.Windows.Forms.ToolStripMenuItem subMenuControlarStock = new System.Windows.Forms.ToolStripMenuItem("Controlar Stock");
            ...
            subMenuControlarStock.Click += new System.EventHandler(SubMenuControlarStockToolStripMenuItem_Click);
            subMenuCompras.Click += new System.EventHandler(SubMenuComprasToolStripMenuItem_Click);

            System.Windows.Forms.ToolStripItem[] itemSubMenuEmpleado = { subMenuEmpleadoListado, subMenuAgregarProducto, subMenuControlarStock };
            System.Windows.Forms.ToolStripItem[] itemSubMenuEmpleadoLista = { subMenuProductos, subMenuUsuarios, subMenuCompras };

            menuEmpleado.DropDownItems.AddRange(itemSubMenuEmpleado);
            subMenuEmpleadoListado.DropDownItems.AddRange(itemSubMenuEmpleadoLista);

            this.menuStrip.Items.Add(menuEmpleado);
        }
        ...
        private System.Windows.Forms.DataGridViewButtonColumn agregarStockColumn;
    }
}